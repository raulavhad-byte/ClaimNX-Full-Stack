        ...
        <main className="flex-1 flex flex-col min-w-0 relative h-full print:h-auto print:block print:overflow-visible">
          ...
          <div className="flex-1 overflow-y-auto overflow-x-hidden min-w-0 max-w-full p-4 lg:p-8 print:p-0 relative">
            ...
            <Routes>
              ...
              <Route path="/crm-handle/:id" element={canAccess('nav_crm') ? <CRMManualHandling claims={visibleClaims} hospitals={visibleHospitals} onUpdate={handleUpdateClaim} onUpdateInsurer={handleUpdateInsurer} onUpdateHospital={(updatedHospital) => {
              ...
              <Route path="/process-claim/:id" element={canAccess('claim_directory') || canAccess('claims_view') ? <ClaimProcessCenter claims={visibleClaims} onUpdate={handleUpdateClaim} onUpdateHospital={setHospitalProfile} stages={stages} fields={fields} userRole={hospitalProfile.role} roles={roles} hospitalProfile={hospitalProfile} kypPolicies={kypPolicies} permissions={currentUserPermissions} canAccessStageAction={canAccessStageAction} /> : <Navigate to="/" replace />} />
              <Route path="/patient-dashboard/:patientName" element={canAccess('patient_dashboard') ? <PatientDashboard claims={visibleClaims} kypPolicies={kypPolicies} setKypPolicies={setKypPolicies} onUpdateClaim={handleUpdateClaim} hospitalProfile={hospitalProfile} setProfileInitialTab={setProfileInitialTab} setShowProfileModule={setShowProfileModule} canAccess={canAccess} insurers={insurers} tpas={tpas} /> : <Navigate to="/" replace />} />
